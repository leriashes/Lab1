...
int main(){
	...
	int a[10],	// Массив для вводимой последовательности
		b[10],	// Массив для новой последовательности
		f,		// Флажок/кол-во чётных чисел, стоящих после нечётных
		i, j,	// Счётчики
		n;		// Кол-во эл-тов последовательности
